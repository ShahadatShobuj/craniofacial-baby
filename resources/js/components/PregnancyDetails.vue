                    ...
                    <v-stepper v-model="question" vertical non-linear class="elevation-0 py-0">
                        ...
                        <v-stepper-content step="1" data-question="1" class="my-0 py-0">
                            ...
                            <v-btn
                                color="primary"
                                v-on:click="question++"
                                :disabled="hasState('1') ? !(checkValidation('1') && waterContaminationTypeValidation) : true"
                                small
                            >
                                Continue
                            </v-btn>                
                        ...
                        <v-stepper-content step="3" data-question="3" class="my-0 py-0">
                            ...
                            <v-btn
                                color="primary"
                                v-on:click="question++"
                                :disabled="hasState('3') ? !(checkValidation('3') && airPollutionTypeValidation) : true"
                                small
                            >
                                Continue
                            </v-btn>                
                        ...
                        <v-stepper-content step="6" data-question="6" class="my-0 py-0">
                            ...
                            <v-btn
                                color="primary"
                                v-on:click="question++"
                                :disabled="hasState('6') ? !(checkValidation('6') && intercourseTimeValidation) : true"
                                small
                            >
                                Continue
                            </v-btn>                
                                    ...
                                    <v-col cols="9" class="py-0" v-if="form.stress">
                                        ...
                                        <v-row class="">
                                            <v-radio-group 
                                                ...
                                                class="my-0"
                                            >
                                                <v-radio value="death_of_close_one" label="Death of Close ONe"></v-radio>
                                                <v-radio value="seperation_or_divorce" label="Seperation/ Divorce"></v-radio>
                                                <v-radio value="loss_of_job" label="Loss of Job"></v-radio>
                                                <v-radio value="familial_difficulties" label="Familial Difficulties"></v-radio>
                                            </v-radio-group>
                                        </v-row>
                                    </v-col>
                                </v-row>
                                    ...
                                    <v-col cols="12" class="py-0">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <v-radio value="Term" label="Term (EDD +- 2 weeks)"></v-radio>
                                                <v-radio value="Post-term" label="Post-term (> 2 weeks after EDD)"></v-radio>
                                            </v-radio-group>
                                        </validation-provider>
                                    </v-col>
                                </v-row>
