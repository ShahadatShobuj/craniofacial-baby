                                    ...
                                    <v-col md="10" class="py-0">
                                        ...
                                        <v-row>
                                            ...
                                            <v-col md="8" class="py-0">
                                                ...
                                                <v-row v-if="form.test_tympanometry">
                                                    <v-col class="py-0">
                                                        <validation-provider
                                                            rules="required"
                                                            v-slot="{ errors, valid, dirty }"
                                        ...
                                        <v-row>
                                            ...
                                            <v-col md="8" class="py-0">
                                                ...
                                                <v-row v-if="form.test_play_audiometry">
                                                    <v-col class="py-0">
                                                        <validation-provider
                                                            rules="required"
                                                            v-slot="{ errors, valid, dirty }"
