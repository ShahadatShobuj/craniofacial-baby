                        ...
                        <v-stepper-items>
                            <v-stepper-content step="1" data-question="1" class="my-0 py-0">
                                <v-row>
                                    ...
                                    <v-col md="9" class="py-0">
                                        <v-row>
                                            <v-col md="4" class="py-0">Bilabial sounds:</v-col>
                                        ...
                                        <v-row>
                                            <v-col md="4" class="py-0">Palatal sounds:</v-col>
                                            <v-col md="8" class="py-0">
                                                <v-row>
                                                    <v-col cols="3" class="py-0">
                                                        (চ) |c|: 
                                        ...
                                        <v-row>
                                            <v-col md="4" class="py-0">Velar sounds:</v-col>
                                            <v-col md="8" class="py-0">
                                                <v-row>
                                                    <v-col cols="3" class="py-0">
                                                        (ক) |k|: 
                                        ...
                                        <v-row>
                                            <v-col md="4" class="py-0">Fricative sounds:</v-col>
                                            <v-col md="8" class="py-0">
                                                <v-row>
                                                    <v-col cols="3" class="py-0">
                                                        (ফ) |f|: 
