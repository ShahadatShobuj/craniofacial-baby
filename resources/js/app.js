...
Vue.component('mother-details', require('./components/MotherDetails.vue').default);
Vue.component('pregnancy-details', require('./components/PregnancyDetails.vue').default);
Vue.component('father-details', require('./components/FatherDetails.vue').default);
Vue.component('delivery-details', require('./components/DeliveryDetails.vue').default);
Vue.component('newborn-details', require('./components/NewbornDetails.vue').default);
Vue.component('speech-development-details', require('./components/SpeechDevelopmentDetails.vue').default);
Vue.component('hearing-development-details', require('./components/HearingDevelopmentDetails.vue').default);
Vue.component('treatment-details', require('./components/TreatmentDetails.vue').default);
Vue.component('outcome-details', require('./components/OutcomeDetails.vue').default);
// Vue.component('input-text', require('./components/forms/InputText.vue').default);
