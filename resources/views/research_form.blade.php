                        ...
                        <v-card-text>
                            <v-stepper v-model="step" class="elevation-0">
                                <v-stepper-header style="height: auto !important">
                                    <v-stepper-step :complete="step > 1" step="1" class="py-1" editable
                                        edit-icon="$complete">
                                        Contact Information
                                    </v-stepper-step>

                                    <v-divider></v-divider>
                                    <v-stepper-step :complete="step > 2" step="2" class="py-1" editable
                                        edit-icon="$complete">
                                        Particulars of Mother
                                    </v-stepper-step>

                                    <v-divider></v-divider>
                                    <v-stepper-step :complete="step > 3" step="3" class="py-1" editable
                                        edit-icon="$complete">
                                        Particulars of Pregnancy
                                    </v-stepper-step>

                                    <v-divider></v-divider>
                                    <v-stepper-step :complete="step > 4" step="4" class="py-1" editable
                                        edit-icon="$complete">
                                        Particulars of Father
                                    </v-stepper-step>

                                    <v-divider></v-divider>
                                    <v-stepper-step :complete="step > 5" step="5" class="py-1" editable
                                        edit-icon="$complete">
                                        Delivery Details
                                    </v-stepper-step>

                                    <v-divider></v-divider>
                                    <v-stepper-step :complete="step > 6" step="6" class="py-1" editable
                                        edit-icon="$complete">
                                        Particulars of Newborn
                                    </v-stepper-step>

                                    <v-divider></v-divider>
                                    <v-stepper-step :complete="step > 7" step="7" class="py-1" editable
                                        edit-icon="$complete">
                                        Speech Development
                                    </v-stepper-step>

                                    <v-divider></v-divider>
                                    <v-stepper-step :complete="step > 8" step="8" class="py-1" editable
                                        edit-icon="$complete">
                                        Hearing Development
                                    </v-stepper-step>

                                    <v-divider></v-divider>
                                    <v-stepper-step :complete="step > 9" step="9" class="py-1" editable
                                        edit-icon="$complete">
                                        Treatment Details
                                    </v-stepper-step>

                                    <v-divider></v-divider>
                                    <v-stepper-step :complete="step > 10" step="10" class="py-1" editable
                                        edit-icon="$complete">
                                        Outcome
                                    </v-stepper-step>
                                </v-stepper-header>
                                ...
                                <v-stepper-items>
                                    <v-stepper-content step="1" class="pa-1">
                                        <contact-details ref="contacDetails" v-on:previous="step--"
                                            v-on:save="saveAndProceed" v-on:reset="reset">
                                        </contact-details>
                                    </v-stepper-content>

                                    <v-stepper-content step="2" class="pa-1">
                                        <mother-details ref="motherDetails" v-on:previous="step--"
                                            v-on:save="saveAndProceed" v-on:reset="reset">
                                        </mother-details>
                                    </v-stepper-content>
                                    ...
                                    <v-stepper-content step="4" class="pa-1">
                                        <father-details ref="fatherDetails" v-on:previous="step--"
                                            v-on:save="saveAndProceed" v-on:reset="reset">
                                        </father-details>
                                    </v-stepper-content>
                                    ...
                                    <v-stepper-content step="6" class="pa-1">
                                        <newborn-details ref="newbornDetails" v-on:previous="step--"
                                            v-on:save="saveAndProceed" v-on:reset="reset">
                                        </newborn-details>
                                    </v-stepper-content>
                                    ...
                                    <v-stepper-content step="10" class="pa-1">
                                        <v-form ref="form" name="outcome" @reset.native="reset"
                                            ...
                                            <v-card class="py-0">
                                                <v-card-text>
                                                    <v-stepper v-model="question" vertical non-linear
                                                                ...
                                                                <v-row>
                                                                    ...
                                                                    <v-col md="6" class="py-0">
                                                                        <validation-provider rules="required"
                                                                            ...
                                                                            <v-radio-group
                                                                                v-model="form.outcome.vision_test" row
                                                                ...
                                                                <v-row>
                                                                    ...
                                                                    <v-col md="8" class="py-0">
                                                                        <validation-provider rules="required"
                                                                            ...
                                                                            <v-radio-group
                                                                                v-model="form.outcome.marital_status" row
                                                                                :error-messages="errors"
                                                                                :success="valid && dirty" class="my-0">
                                                                        ...
                                                                        <v-row
                                                                            v-if="form.outcome.marital_status === 'Married'">
                                                                            <v-col md="4" class="py-0">
                                                                                If married:
                                                                            </v-col>
                                                                            <v-col md="8" class="py-0">
